...
export default async function Layout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  const [variant, collapsible, themeMode, themePreset, contentLayout, navbarStyle, selectedRole] = await Promise.all([
  ...
  return (
    ...
    >
      <AppSidebar variant={variant} collapsible={collapsible} selectedRole={selectedRole as RoleSlug | undefined} />
      <SidebarInset
        className={cn(
